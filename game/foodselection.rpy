...
screen foodselection():
    ...
    imagebutton:
        ...
        action [SetVariable("selectedfood", "cup"), Return()]
    imagebutton:
        focus_mask True
        ...
        align (0.2, 0.62)
        at Transform(zoom = 0.3)
        action [SetVariable("selectedfood", "spicy"), Return()]
    # Fridge Door Sprites
    if not fridgeopen:
        imagebutton:
            focus_mask True
        ...
        imagebutton:
            ...
            align (0.68, 0.35)
            at Transform(zoom = 0.3)
            action [SetVariable("selectedfood", "lasagna"), Return()]
        imagebutton:
            focus_mask True
            ...
            align (0.95, 0.35)
            at Transform(zoom = 0.3)
            action [SetVariable("selectedfood", "mac"), Return()]
        imagebutton:
            focus_mask True
            ...
            align (0.65, 1.2)
            at Transform(zoom = 0.3)
            action [SetVariable("selectedfood", "meat"), Return()]
        imagebutton:
            focus_mask True
            ...
            align (0.95, 1.0)
            at Transform(zoom = 0.3)
            action [SetVariable("selectedfood", "poptart"), Return()]